...
class ReplayBuffer(object):
    ...
    def _encode_sample(self, idxes):
        ...
        return np.array(obses_t), np.array(agent_actions), np.array(other_actions), np.array(rewards), np.array(obses_tp1), np.array(dones)
    ...
    def sample(self, batch_size):
        ...
        agent_act_batch: np.array

            batch of agent's actions executed given obs_batch

        other_act_batch: np.array

            batch of other agent's actions executed given obs_batch
